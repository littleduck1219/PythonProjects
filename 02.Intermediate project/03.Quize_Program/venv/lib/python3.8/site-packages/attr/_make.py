...
def attrib(
    ...
    :param type: The type of the attribute.  In Python 3.6 or greater, the
        preferred method to specify the type is using a variable annotations
        (see :pep:`526`).
    ...
    if these is not None:
        ...
        if len(unannotated) > 0:
            raise UnannotatedAttributeError(
                "The following `attr.ib`s lack a type annotations: "
                + ", ".join(
            ...
            for name in self._attr_names:
                if (
                    ...
                    try:
                        ...
                        # same name by using only a type annotations.
                        pass
...
def attrs(
    ...
    :param bool auto_attribs: If ``True``, collect :pep:`526`-annotated
        ...
        annotations, an `attr.exceptions.UnannotatedAttributeError` is
    ...
    *Read-only* representation of an attribute.
    ...
    def from_counting_attr(cls, name, ca, type=None):
        ...
        if type is None:
            ...
            raise ValueError(
                "Type annotations and type argument cannot both be present"
            )
        inst_dict = {
            k: getattr(ca, k)
